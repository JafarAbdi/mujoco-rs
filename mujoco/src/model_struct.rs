...
impl Model {
    ...
    pub fn nJfe(&self) -> usize {
        self.raw().nJfe as usize
    }
    pub fn nJfv(&self) -> usize {
        self.raw().nJfv as usize
    }
    ...
    pub fn nhistory(&self) -> usize {
        self.raw().nhistory as usize
    }
    ...
    /// linear: 1; angular: approx. length scale
    pub fn dof_length(&self) -> &[mjtNum] {
        unsafe { std::slice::from_raw_parts(self.raw().dof_length, self.nv()) }
    }

    /// start addr of bodies
    pub fn tree_bodyadr(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().tree_bodyadr, self.ntree()) }
    }

    /// number of bodies in tree
    pub fn tree_bodynum(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().tree_bodynum, self.ntree()) }
    }

    /// start addr of dofs
    pub fn tree_dofadr(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().tree_dofadr, self.ntree()) }
    }

    /// number of dofs in tree
    pub fn tree_dofnum(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().tree_dofnum, self.ntree()) }
    }

    /// sleep policy (mjtSleepPolicy)
    pub fn tree_sleep_policy(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().tree_sleep_policy, self.ntree()) }
    }
    ...
    /// projection type (mjtProjection)
    pub fn cam_projection(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().cam_projection, self.ncam()) }
    }
    ...
    /// output types (mjtCamOut bit flags)
    pub fn cam_output(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().cam_output, self.ncam()) }
    }
    ...
    /// passive collisions enabled
    pub fn flex_passive(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().flex_passive, self.nflex()) }
    }
    ...
    /// first edge address
    pub fn flex_vertedgeadr(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().flex_vertedgeadr, self.nflexvert()) }
    }

    /// number of edges
    pub fn flex_vertedgenum(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().flex_vertedgenum, self.nflexvert()) }
    }

    /// edge indices
    pub fn flex_vertedge(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().flex_vertedge, self.nflexedge() * 2) }
    }
    ...
    pub fn flex_vertmetric(&self) -> &[mjtNum] {
        unsafe { std::slice::from_raw_parts(self.raw().flex_vertmetric, self.nflexvert() * 4) }
    }
    ...
    pub fn flex_size(&self) -> &[mjtNum] {
        unsafe { std::slice::from_raw_parts(self.raw().flex_size, self.nflex() * 3) }
    }
    ...
    pub fn flex_bending(&self) -> &[mjtNum] {
        unsafe { std::slice::from_raw_parts(self.raw().flex_bending, self.nflexedge() * 17) }
    }
    ...
    /// 0: none, 1: edges, 2: vertices
    pub fn flex_edgeequality(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().flex_edgeequality, self.nflex()) }
    }

    /// are all vertices in the same body
    ...
    pub fn flexedge_J_rownnz(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().flexedge_J_rownnz, self.nflexedge()) }
    }

    /// row start address in colind array
    pub fn flexedge_J_rowadr(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().flexedge_J_rowadr, self.nflexedge()) }
    }

    /// column indices in sparse Jacobian
    pub fn flexedge_J_colind(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().flexedge_J_colind, self.nJfe()) }
    }

    /// number of non-zeros in Jacobian row
    pub fn flexvert_J_rownnz(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().flexvert_J_rownnz, self.nflexvert() * 2) }
    }

    /// row start address in colind array
    pub fn flexvert_J_rowadr(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().flexvert_J_rowadr, self.nflexvert() * 2) }
    }

    /// column indices in sparse Jacobian
    pub fn flexvert_J_colind(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().flexvert_J_colind, self.nJfv() * 2) }
    }
    ...
    /// number of trees along tendon's path
    pub fn tendon_treenum(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().tendon_treenum, self.ntendon()) }
    }

    /// first two trees along tendon's path
    pub fn tendon_treeid(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().tendon_treeid, self.ntendon() * 2) }
    }
    ...
    /// history buffer: [nsample, interp]
    pub fn actuator_history(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().actuator_history, self.nu() * 2) }
    }

    /// address in history buffer; -1: none
    pub fn actuator_historyadr(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().actuator_historyadr, self.nu()) }
    }

    /// delay time in seconds; 0: no delay
    pub fn actuator_delay(&self) -> &[mjtNum] {
        unsafe { std::slice::from_raw_parts(self.raw().actuator_delay, self.nu()) }
    }
    ...
    /// history buffer: [nsample, interp]
    pub fn sensor_history(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().sensor_history, self.nsensor() * 2) }
    }

    /// address in history buffer; -1: none
    pub fn sensor_historyadr(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().sensor_historyadr, self.nsensor()) }
    }

    /// delay time in seconds; 0: no delay
    pub fn sensor_delay(&self) -> &[mjtNum] {
        unsafe { std::slice::from_raw_parts(self.raw().sensor_delay, self.nsensor()) }
    }

    /// interval: [period, phase] in seconds
    pub fn sensor_interval(&self) -> &[mjtNum] {
        unsafe { std::slice::from_raw_parts(self.raw().sensor_interval, self.nsensor() * 2) }
    }
    ...
    pub fn B_rownnz(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().B_rownnz, self.nbody()) }
    }

    /// body-dof: row addresses
    pub fn B_rowadr(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().B_rowadr, self.nbody()) }
    }

    /// body-dof: column indices
    pub fn B_colind(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().B_colind, self.nB()) }
    }

    /// reduced inertia: non-zeros in each row
    pub fn M_rownnz(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().M_rownnz, self.nv()) }
    }

    /// reduced inertia: row addresses
    pub fn M_rowadr(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().M_rowadr, self.nv()) }
    }

    /// reduced inertia: column indices
    pub fn M_colind(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().M_colind, self.nC()) }
    }

    /// index mapping from qM to M
    pub fn mapM2M(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().mapM2M, self.nC()) }
    }

    /// full inertia: non-zeros in each row
    pub fn D_rownnz(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().D_rownnz, self.nv()) }
    }

    /// full inertia: row addresses
    pub fn D_rowadr(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().D_rowadr, self.nv()) }
    }

    /// full inertia: index of diagonal element
    pub fn D_diag(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().D_diag, self.nv()) }
    }

    /// full inertia: column indices
    pub fn D_colind(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().D_colind, self.nD()) }
    }

    /// index mapping from M to D
    pub fn mapM2D(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().mapM2D, self.nD()) }
    }

    /// index mapping from D to M
    pub fn mapD2M(&self) -> &[i32] {
        unsafe { std::slice::from_raw_parts(self.raw().mapD2M, self.nC()) }
    }
